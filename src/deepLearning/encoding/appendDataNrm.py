...
if __name__ == "__main__":
    ...
    x_train, t_train, analysis_train = total_train_list.getAppendTotalList(UmamusumeClass)
    ...
    x_test, t_test, analysis_test = total_test_list.getAppendTotalList(UmamusumeClass)
